...
const VenueDetail = () => {
  ...
  const mockVenue = {
    ...
    description: "A premier multi-sport facility located in the heart of Bandra West, Mumbai, offering world-class amenities and professional-grade equipment for athletes of all levels.",
    ...
    sports: [
      {
        ...
        pricePerHour: 1500,
        available: true,
        description: "Professional basketball courts with NBA regulation dimensions"
      },
      {
        name: "Volleyball",
        pricePerHour: 1500,
    ...
    reviews: [
      {
        ...
        rating: 5,
        date: "2024-01-15",
        comment: "Excellent facility! The basketball courts are in perfect condition and the staff is very friendly. Highly recommend!"
      },
      {
        id: 2,
        user: "Sarah M.",
        rating: 4,
        date: "2024-01-10",
        comment: "Great place for volleyball practice. The courts are well-maintained and the lighting is perfect for evening games."
      },
      {
        id: 3,
        user: "Mike R.",
        rating: 5,
        date: "2024-01-08",
        comment: "Been coming here for years. Clean facilities, good equipment, and reasonable prices. Can't ask for more!"
      }
    ],
    openingHours: {
    ...
    <div className="venue-detail-container">
      ...
      <div className="venue-header">
        ...
        <div className="venue-meta">
          <div className="rating">
            ...
            <span className="review-count">({venue.totalReviews} reviews)</span>
          </div>
        ...
        <div className="venue-info-grid">
              ...
              {venue.sports.map((sport, index) => (
                <div key={index} className="sport-item">
                  <div className="sport-header">
                    <h3>{sport.name}</h3>
                    <span className="price">Rs {sport.pricePerHour}/hour</span>
                  </div>
                  <p className="sport-description">{sport.description}</p>
                  <span className={`availability ${sport.available ? 'available' : 'unavailable'}`}>
          ...
          <div className="info-section">
            ...
            <div className="contact-info">
              ...
              <div className="contact-item">
                <span className="contact-icon">🌐</span>
                <a href={`https://${venue.contact.website}`} target="_blank" rel="noopener noreferrer">
        ...
        <div className="reviews-section">
          ...
          <div className="reviews-summary">
            <div className="overall-rating">
              ...
              <div className="total-reviews">{venue.totalReviews} reviews</div>
            </div>
          </div>
      ...
      <div className="booking-section">
        <div className="booking-info">
          <h3>Ready to Book?</h3>
                          <p>Starting from Rs {Math.min(...venue.sports.map(s => s.pricePerHour))}/hour</p>
        </div>
      ...
      {showAllPhotos && (
        <div className="photo-modal" onClick={() => setShowAllPhotos(false)}>
          <div className="modal-content" onClick={e => e.stopPropagation()}>
            <button className="close-modal" onClick={() => setShowAllPhotos(false)}>×</button>
