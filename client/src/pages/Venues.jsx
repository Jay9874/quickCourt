...
export const Venues = () => {
  ...
  useEffect(() => {
    filterVenues()
  }, [searchTerm, selectedSport, selectedPrice, selectedVenueType, selectedRating, venues])
  ...
  const filterVenues = () => {
    let filtered = venues.filter(venue => {
      ...
      const matchesPrice = !selectedPrice || 
        ...
        (selectedPrice === 'medium' && venue.pricePerHour > 1500 && venue.pricePerHour <= 2500) ||
        (selectedPrice === 'high' && venue.pricePerHour > 2500)
      
      const matchesVenueType = !selectedVenueType || venue.venueType === selectedVenueType
      
      const matchesRating = !selectedRating || venue.rating >= parseInt(selectedRating)
      
      return matchesSearch && matchesSport && matchesPrice && matchesVenueType && matchesRating
    })
